...
<head>
   ...
   <title> Login | PawsitiveMatch | A Digital Pet Adoption Platform </title>
   <link rel="stylesheet" href="./css/login.css">
   <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
   <script src="./js/login_owner.js"></script>
   ...
   <main>
      <div class="logo-title">
         <div class="logo">
            ...
            <!-- <h1> PawsitiveMatch </h1> -->
         </div>
         <div class="text-logo">
            <p> A Digital Pet Adoption Platform and <br> Adoption Center </p>
         </div>
      </div>
