...
$sel_owner_logged_res = mysqli_query($conn, $sel_owner_logged_query);

$owner_logged = mysqli_fetch_assoc($sel_owner_logged_res);


$verify_status = $owner_logged['status'];
...
<body>
   ...
   <main>
      ...
      <form id="checking" action="./process/ownerVerifiy.php" method="POST" enctype="multipart/form-data">

         <div class="form-step-container">

            <!--  -->
            <div class="form-owner-info">
            ...
            <div class="form-owner-avatar">

               <div class="avatar-preview" id="avatar-preview">
                  <label for="owner-avatar">
               ...
               <div class="form-input">
                  ...
                  <input type="file" name="owner_avatar" style="display:none" accept="image/png, image/jpg, image/jpeg" id="owner-avatar" required>
            ...
            <div class="form-owner-change-pass">
...
<script>
   const pet_img_input = document.querySelector('#owner-avatar');
   ...
   $(document).ready(function() {
      ...
      $('#next-1').click(function() {
         ...
         var owner_avatar = $('#owner-avatar').val();
         ...
         if (firstname.trim() == '' || lastname.trim() == '' || contact.trim() == '' || address.trim() == '') {
            ...
            $('.form-owner-info').hide();
            $('.form-owner-avatar').css('display', 'flex');
      ...
      $('#next-2').click(function() {
         ...
         var owner_image = $('#owner-avatar').val();
         ...
         if (owner_image === '') {
            ...
            $('.form-owner-change-pass').css('display', 'flex');
            $('.form-owner-avatar').hide();
      ...
      $('#back').click(function() {
         ...
         // $('.form-owner-info').hide();
         $('.form-owner-change-pass').css('display', 'none');
         $('.form-owner-avatar').show();
      ...
      $('#back-2').click(function() {
         ...
         $('.form-owner-info').show();
         $('.form-owner-avatar').css('display', 'none');
