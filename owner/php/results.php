<?php
  ...
  //  $showing_pet_adopted = ($num_rows < 10) ? $num_rows : 10;
   ...
   // owner log
   $res_owner = mysqli_query($conn, "SELECT * FROM owner_status WHERE status='active'");
   $num_rows = mysqli_num_rows($res_owner);
  //  $showing_pet_adopted = ($num_rows < 10) ? $num_rows : 10;
   $total_owner = $num_rows;
   ...
   //  $showing_pet_adopted = ($num_rows < 10) ? $num_rows : 10;
    ...
    // archived
    $res_archived = mysqli_query($conn, "SELECT * FROM owner_status WHERE status='inactive'");
   ...
   //  $showing_pet_adopted = ($num_rows < 10) ? $num_rows : 10;
    ...
    // activity log
    $res_activity_log = mysqli_query($conn, "SELECT * FROM activity_log WHERE user_type='owner'");
