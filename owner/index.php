...
$verify_status = $owner_logged['owner_verifiy'];
$user_type = $owner_logged['user_type'];
...
if ($verify_status === 'not verified') {
   header("location: ./owner_verification.php");
}
?>
...
<head>
   ...
   <link rel="stylesheet" href="./css/add_owner_modal.css">
   <link rel="stylesheet" href="./css/view_owner_modal.css">
...
<?php include "./includes/style_if-owner.php" ?>
...
<body oncontextmenu="return true;">
   <main>
      ...
      <div class="side-navigation">
         ...
         <div class="logo">
            <img src="../assets/icons/client_logo.png">
         </div>
         ...
         <nav class="nav-bar main-nav">
            <ul>
               ...
               <!-- owners icon -->
               <!--<li>-->
               <!--   <div class="nav-link owners-icon">-->
               <!--      <div class="icon">-->
               <!--         <i class="fas fa-users-cog"> </i>-->
               <!--      </div>-->

               <!--      <p class="link-name"> owners </p>-->
               <!--   </div>-->
               <!--</li>-->
      ...
      <div class="main-content">
         ...
         <header class="main-header">
            ...
            <div class="account-items">
               <div class="account-name-icon">
                  <div class="my-name">
                     <?php if (empty($owner_logged['avatar'])) { ?>
                     ...
                     <div class="text">
                        <h3> Welcome back, <span style="text-transform: capitalize;"> <?= $owner_logged['firstname'] ?> </span></h3>
                     </div>
                  ...
                  <div class="account-menu">
                     <div class="acc-name">
                        ...
                        <div class="text">
                           <h4> <?= $owner_logged['firstname'] ?> <?= $owner_logged['lastname'] ?></h4>
                           <p> <?= $owner_logged['user_type'] ?> </p>
                        </div>
                     </div>
                     <hr>
         ...
         <div class="content-container">
            ...
            <div class="sections">
               ...
               <!-- ownerS -->
               <!--<section class="container cnt-owners">-->
               ...
               <!--            <a href="#" class="btn-add-owner"> Add New Staff </a>-->
               <!--         </div>-->
               <!--      </div>-->
               ...
               <!--   <div class="owner-item-container" id="owner-item-display">-->
                     <!-- go to ./php/pagination_owner.php -->
               <!--   </div>-->

                  <!-- ADD owner MODAL -->
               <!--   <div class="add-owner-modal" id="add-owner-modal">-->
               <!--      <div class="form">-->
               <!--         <div class="title-modal-owner">-->
               ...
               <!--            <div class="form-input">-->
               <!--               <select name="ownerType" id="owner-type" class="owner-type" required>-->
               <!--                  <option value=""> --Select Access Level-- </option>-->
               <!--                  <option value="owner"> Staff </option>-->
               <!--                  <option value="super owner"> owner </option>-->
               <!--               </select>-->
               <!--            </div>-->

               <!--            <div class="form-button">-->
               <!--               <input type="button" value="Cancel" class="owner-cancel-btn">-->
               <!--               <input type="button" value="Register Email" class="owner-add-btn" name="btnAddowner" id="btn_add_owner">-->
               <!--            </div>-->
               <!--         </form>-->
               <!--      </div>-->
               <!--   </div>-->
                  ...
                  <!-- VIEW owner MODAL -->
               <!--   <div class="view-owner-modal" id="view-owner-modal">-->
                        ...
                        <div class="filter">
                           ...
                           <div class="sort-by">
                              ...
                              <select name="sort-by" id="sort-by-report">
                                 ...
                                 <option value="user_id"> owner ID </option>
                                 <option value="email"> Email </option>
               ...
               <section class="container cnt-archive">
                  ...
                  <div class="archive-item-container" id="archive-item-container">
                     ...
                     $sel_inactive_owner_query = "SELECT * FROM `owner_info` a 
                              ...
                              WHERE b.account_id != '$owner_id' AND d.status = 'inactive' ORDER BY a.id DESC LIMIT 10;";
                     ...
                     <table border="0" width="100%">
                        ...
                        <tbody>
                           ...
                           $sel_activity_log_query = "SELECT *, a.id as `act_id` FROM `activity_log` a
                              ...
                              WHERE a.users_id != '$owner_id' AND a.user_type != 'super owner'
                              ORDER BY a.id DESC
                              LIMIT 10";
...
<script src="./ajax/add_owner.js"></script>
<script src="./ajax/all_owner.js"></script>
