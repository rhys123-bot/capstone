...
<head>
   ...
   <title> <?=strtoupper($user_type)?> | PawsitiveMatch A Digital Pet Adoption Platform</title>
      ...
      <div class="side-navigation">
         ...
         <nav class="nav-bar main-nav">
            <ul>
               ...
               <!-- missing pets icon -->
               <!-- <li> 
                  <div class="nav-link missing-pets-icon">
                     <div class="icon"> 
                        <i class="fas fa-search"></i>
                     </div>

                     <p class="link-name"> Missing Pets </p>
                  </div>
               </li> -->
            ...
            <ul>
               ...
               <!-- <li> 
                  <div class="nav-link">
                     ...
                     <p class="link-name"> Edit Content </p>  
                  </div>
               </li> -->
      ...
      <div class="main-content">
         ...
         <header class="main-header">
            ...
            <div class="text-header">
               <p> PawsitiveMatch A Digital Pet Adoption Platform
               </p>
               <span> 
                A Digital Pet Adoption Platform | PawsitiveMatch
               </span>
            ...
            <a href="#" class="dropdown-toggle"><span class="label label-pill label-danger count"></span> <i class="fas fa-bell" style="font-size:18px;"></i></a>
                  ...
                  <div class="dashboard-header">
                     ...
                     <div class="title-wmy-container">
                        ...
                        <div class="week-mos-yr">
                           <!-- <div class="wmy weekly-text wmySelected">
                              <h3> Weekly </h3>
                           </div> -->
                     ...
                     <div class="card-container">
                        ...
                        <div class="card-box">
                           ...
                           <div class="card-total">
                              <h1> <?=mysqli_num_rows($res_pet_query)?> </h1>
                     ...
                     <div class="filter-box">
                        <div class="filter">
                           <div class="search">
                              ...
                              <input type="search" name="user-fil-search" id="user-search" placeholder="Search...">
                           </div>
                  ...
                  <div class="admins-header">
                     ...
                     <div class="title-text">
                        ...
                        <div class="admin-button">
                           <a href="#" class="btn-add-admin"> Add New Admin </a>
                        </div>
                     </div>
                  ...
                  <div class="add-admin-modal" id="add-admin-modal">
                     <div class="form">
                        <div class="title-modal-admin">
                           <h3> <i class="fas fa-user-cog"></i> Add new admin  </h3>
                           <hr>
                        </div>
                  ...
                  <div class="appl-content-container">
                     ...
                     <div class="appl-main-container">
                        ...
                        <div class="sub-application appl sub-display">
                           ...
                           <div class="appls-header">
                              ...
                              <div class="filter-box">
                                 <div class="filter">
                                    <div class="search">
                                       <i class="fa fa-search"></i>
                                       <input type="search" name="fil-search" id="approve-appl-search" placeholder="Search...">
                                    </div>
                                 </div>
                                 <div class="result">
                           ...
                           <div class="appl-item-container" id="appl-item-container">
                        ...
                        <div class="sub-application f-int">
                           <div class="f-ints-header">
                              ...
                              <div class="filter-box">
                                 <div class="filter">
                                    <div class="search">
                                       <i class="fa fa-search"></i>
                                       <input type="search" name="fil-search" id="trans-appl-search" placeholder="Search...">
                                    </div>
                           ...
                           <div class="f-int-item-container" id="f-int-item-container">
                  ...
                  <div class="services-content-container">
                     ...
                     <div class="services-sub-menu">
                        ...
                        <ul>
                           ...
                           <li> 
                              <div class="services-sub-link services-sched"> <p> Services </p> <i class="fas fa-cog"></i> </div> 
                           </li>
                           <li> 
                              <div class="services-sub-link services-arch"> <p> Add Services </p> <i class="fas fa-plus-circle"></i> </div> 
                           </li>
                           
                           <li> 
                              <div class="services-sub-link services-log "> <p> Service Log </p> <i class="fas fa-archive" aria-hidden="true"></i></div>
                           </li>
                        </ul>
                           ...
                           <div class="applicants-header">
                              ...
                              <div class="filter-box">
                                 <div class="filter">
                                    <div class="search">
                                       <i class="fa fa-search"></i>
                                       <input type="search" name="fil-search" id="ser-search" placeholder="Search...">
                                    </div>
               ...
               <section class="container cnt-pets"> 
                  <div class="pets-content-container">
                     ...
                     <div class="pets-sub-menu">
                        ...
                        <ul>
                           <li> 
                              <div class="pets-sub-link pets-all pets-selected"> <p> All Pets </p> <i class="fas fa-paw" aria-hidden="true"></i></div>
                           </li>
                           <li> 
                              <div class="pets-sub-link pets-adopted"> <p> Adopted Pets </p> <i class="fas fa-cog"></i> </div> 
                           </li>
                           <li> 
                              <div class="pets-sub-link pets-add"> <p> Add New Pets </p> <i class="fas fa-plus-circle    "></i> </div> 
                           </li>
                           ...
                           <div class="all-pets-header">
                              ...
                              <div class="filter-box">
                                 <div class="filter">
                                    <div class="search">
                                       <i class="fa fa-search"></i>
                                       <input type="search" name="pet-search" id="pet-search" placeholder="Search...">
                                    </div>
                           ...
                           <div class="adopted-pets-header">
                              ...
                              <div class="filter-box">
                                 <div class="filter">
                                    <div class="search">
                                       <i class="fa fa-search"></i>
                                       <input type="search" name="adopted-search" id="adopted-search" placeholder="Search...">
                                    </div>
                  ...
                  <div class="reports-header">
                     ...
                     <div class="filter-box">
                        <div class="filter">
                           <div class="search">
                              <i class="fa fa-search"></i>
                              <input type="search" name="report-search" id="report-search" placeholder="Search...">
                           </div>
               ...
               <section class="container cnt-report">
                  ...
                  <div class="filter-generate">
                     ...
                     <div class="form-input">
                        ...
                        <input type="date" class="rep-cus-date" id="rep-from-date" max="<?=$curr_date?>" min="2015-01-01" disabled>
                     </div>

                     <div class="form-input">
                        <label for="to-date"> To: </label>
                        <input type="date" class="rep-cus-date" id="rep-to-date" max="<?=$curr_date?>" min="2015-01-01" disabled>
                     </div>
                  ...
                  <div class="generate-report-container" id="generate-report-container">
                     ...
                     <div class="content">
                        ...
                        <!-- <div class="graphs-container">
                           <div class="report-line-graph">
                              <canvas id="reportLineGraph" class="reportLineGraph"></canvas>
                             
                           </div>
                           <div class="report-pie-chart">
                              <canvas id="reportPieChart" class="reportPieChart"></canvas>
...
<!-- <script src="./js/select_based_type_pet.js"> </script> -->
...
<!-- <script src="./ajax/add_pets.js"></script> -->
