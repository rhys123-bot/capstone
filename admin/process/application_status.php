    ...
    while($adoption_rows = mysqli_fetch_assoc($res_adoption_pending)) {
        ...
        if($adoption_rows['reference_no'] == $ref_no) {
            ...
            // echo $image_path;
                ...
                $html_content .= '<li>Naga City, Naga Cebu</li>';
                $html_content .= '<br><li style="font-size: 12px;">6<sup>th</sup> South Poblacion, City of Naga, Cebu., PAP.</li>';
                $html_content .= '<span style="font-size: 12px;">Email Address: PawsitiveMatch@gmail.com | Tel no.: 9949150122 loc. 6018</span>';
                $html_content .= '</ul>';
                $html_content .= '</div>';
                ...
                $html_content .= '<li>I give the Naga City VETERINARY DEPARTMENT (PawsitiveMatch) permission to call my home and to inspect the premises under which this animal is kept and if during the time of inspection, the PawsitiveMatch representative believes those conditions unsuitable or finds the dog unwell and/or manifesting ill treatment whatsoever, I understand, authorize and agree that PawsitiveMatch shall remove this animal from my control, without prior notice or my permission. I understand that I will not have recourse of any kind resulting from such action.</li>';
                ...
                $html_content .= '<p style="text-indent: 30px; text-align: justify;" >This adoption Indemnification Agreement is executed by the referenced ADOPTER for and in consideration of the sum of 500.00; pursuant to SEC. 44 of the Ord. No. SP 2505 S-2016 also known as Naga City Veterinary Code. The receipt of which is hereby indemnifies and holds harmless the Naga City LGU, PawsitiveMatch, and employees against any and all claims, losses, damages, liabilities, penalties, punitive damages, expenses, reasonable legal fees and cost of any kind or amount whatsoever, including any third-party claims, that may arise out from adoption Contract.</p>';
                ...
                $html_content .= '<div style="display: inline-block; margin-bottom: 10px;">F01IAC PawsitiveMatch- 00</div>';
                $html_content .= '</div>';
                ...
                $html_content_page2 .= '<li>Naga City, Naga Cebu</li>';
                $html_content_page2 .= '<br><li style="font-size: 12px;">6<sup>th</sup> South Poblacion, City of Naga, Cebu., PAP.</li>';
                $html_content_page2 .= '<span style="font-size: 12px;">Email Address: PawsitiveMatch@gmail.com | Tel no.: 9949150122 loc. 6018</span>';
                ...
                $html_content_page2 .= '<div style="display: inline-block; text-indent: 30px; text-align: left; width: 63%; margin-bottom: 9px; margin-top: 40px;">( ) NCITIZEN ( ) OTHERS _________________</div>';
                ...
                $html_content_page3 .= '<li>Naga City, Naga Cebu</li>';
                $html_content_page3 .= '<br><li style="font-size: 12px;">6<sup>th</sup> South Poblacion, City of Naga, Cebu., PAP.</li>';
                $html_content_page3 .= '<span style="font-size: 12px;">Email Address: PawsitiveMatch@gmail.com | Tel no.: 9949150122 loc. 6018</span>';
                ...
                $html_content_page4 .= '<div style="text-align: left; text-indent: 10px;">Naga City Animal Care and Adoption Center <span style="margin-left: 165px;">https://www.isagip.site</span></div>';
                $html_content_page4 .= '</div>';
