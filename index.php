...
<body>
  ...
  <section class="hero">
    ...
    <div class="content">
      <h1 class="hero-title">PawsitiveMatch A Digital Pet Adoption Platform</h1>
  </section>
  ...
  <section class="qcanimal-desc">
    ...
    <div>
      <p>PawsitiveMatch is an innovative, user-friendly digital platform designed to make pet adoption easier, safer, and more efficient. Our mission is to connect loving families with rescue pets in need of forever homes, all while promoting responsible pet ownership and supporting animal welfare organizations.</p>
    </div>
  </section>
    ...
    <div class="faqs-content">
      ...
      <div class="faqs-cards">
        ...
        <div class="faqs-cards-answer">
          ...
          <div class="indent">
            <ol type="1">
              <li> Inquire at PawsitiveMatch Team about the request for spay and neuter </li>
